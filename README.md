...
> S360 Base Framework features: [Angular 2](https://angular.io) ([Router](https://angular.io/docs/js/latest/api/router/), [Bootstrap 3](#),[Forms](https://angular.io/docs/js/latest/api/forms/),
...
```bash
# clone our repo
git clone https://github.com/messified/s360.web.baseframework.git

# change directory to our repo
cd s360.web.baseframework
